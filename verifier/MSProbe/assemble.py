...
def assembleOneOpInstruction(ins):
	...
	### addition- support ability to call a fixed address
	if instr == 'call' and '&' in arg:
		output[start:end] = [int('0xb012',16), int('0x'+arg[5]+arg[6]+arg[3]+arg[4],16)]
		# print(f"output = {[hex(x) for x in output[start:end]]}")
